...
foreach ( $suggestions as $suggestion ) {
	...
	if ( $counter < 5 ) {
		...
		?><div>
			...
			<button onclick="nbtAddCitation(<?php echo $_POST['citationsid']; ?>, '<?php echo $_POST['citationsuffix']; ?>', <?php echo $_POST['refset']; ?>, <?php echo $_POST['reference']; ?>, <?php echo $suggestion['id']; ?>, <?php echo $_SESSION['nbt_userid']; ?>);">Add citation</button>
		</div><?php
